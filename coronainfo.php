...
.dropdown:hover .dropbtn {
  ...
  <h2>Government travel restrictions and advisories </h2>
    ...
    <div class="col-8">
    <p>For the best support, please sign in using your account. If you do not have an account, you can use your booking confirmation number and PIN code to sign in on a desktop computer or a laptop.<br>
    ...
    <div class="col-8">
    <p>Moving your booking to a future date depends on the policies of the reservation. Please sign in using either your account or confirmation number and PIN, select the booking you want to change, and you’ll see what options are available.
        <br>
    ...
    <div class="col-8">
    <p>If you change your dates and the property has availability there may be a difference in price (higher or lower). This may be due to seasonality or different rates on weekdays versus weekends.
        <br>
