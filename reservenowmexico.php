...
<form name= "form3" method="post" action="reservationmexico_create.php" >


  <div class="booking-form-box">
      <Label>Hotel *</Label>
      <select name="hotel">
                    <option value="Royalton Chic Suites Cancun Resort & Spa"> Royalton Chic Suites Cancun Resort & Spa </option>
                    <option value="Grand Fiesta Americana Coral Beach Cancun"> Grand Fiesta Americana Coral Beach Cancun </option>
                    <option value="Grand Fiesta Americana Puerto Vallarta"> Grand Fiesta Americana Puerto Vallarta </option>
                    <option value="Hotel Posada De Roger">Hotel Posada De Roger</option>
