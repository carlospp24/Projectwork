...
<fieldset>
    ...
    <form action="regMex.php" method="post">
        <div class="row1">
            <div class="col">
                <fieldset>
                    <legend>
        ...
        <div class="row1">
            <div class="col">
                <fieldset>
                    <legend></legend>
                    <label for ="age">Age:</label><input type="age" name ="age" id="age" required placeholder="Age" pattern="[0-9]{3}" title="Enter a valid Age">
...
<fieldset>
<form method="post" action="http://localhost:82/Github/Projectwork/regMex.php">
