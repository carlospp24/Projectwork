...
<html lang="en">
  ...
  <div class="container">
            <div class="row">
                 ...
                 <h1>Who Are We?</h1>
                  <p class="hometext">We are your BEST option to find nice and confortable destinations and accomodations mainly focused on beaches and tropical warm areas! With us, you can easily look for a cheap and luxurious destination alongside a nice and coazy accomodation. At the moment, we are present in Europe and North America and we are planning on expanding to more nice and coazy locations all around the world.</p>
                
                     
                 </div>
                 <div class="col-8">
                <img src="http://localhost:82/Github/Projectwork/images/denia3.jpg" alt="" style=" width: 800px;padding-top: 2rem; padding-left: 15rem; ">
                 </div>
                </div>
                <div class="row">
                 <div class="col-8">
                 
                 <img src="http://localhost:82/Github/Projectwork/images/fondo7.jpg" alt="" style=" width: 600px;padding-top: 2rem;">
                ...
                <div class="row">
                 ...
                 <div class="col-8">
                     <img src="http://localhost:82/Github/Projectwork/images/sunset.jpg" alt="" style=" width: 800px;padding-top: 2rem;padding-left: 15rem;">
